...
{
  L4Re::chkcap(object_pool.cap_alloc()->alloc(_task));
  _task->task_cap(L4Re::chkcap(object_pool.cap_alloc()->alloc<L4::Task>()));
  _task->thread_cap(L4Re::chkcap(object_pool.cap_alloc()->alloc<L4::Thread>()));
