...
enum l4re_rm_flags_values {
  ...
  L4RE_RM_F_DETACH_FREE  = 0x200, /**< Free the portion of the data space after detach */
 ...
 */
L4_CV L4_INLINE int
l4re_rm_attach_w_info(void **start, unsigned long size, l4re_rm_flags_t flags,
                      l4re_ds_t mem, l4re_rm_offset_t offs,
                      unsigned char align,
                      char const *name,
...
l4re_rm_attach_w_info(void **start, unsigned long size, l4re_rm_flags_t flags,
                      ...
                      l4re_ds_offset_t backing_offset) L4_NOTHROW
{
  return l4re_rm_attach_w_info_srv(l4re_global_env->rm, start, size,
                                   flags, mem, offs, align,
                                   name, backing_offset);
}
