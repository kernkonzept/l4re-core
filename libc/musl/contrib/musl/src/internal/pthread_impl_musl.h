...
struct pthread {
	// TODO: Make this the tcb_head on x86_64
	/* Part 1 -- these fields may be external or
	 * internal (accessed via asm) ABI. Do not change. */
	struct pthread *self; // accessed from __get_tp
#ifndef TLS_ABOVE_TP
	...
	// TODO: Make this the tcb_head(or tail, or just tcb) on all other arches.
	/* Part 3 -- the positions of these fields relative to
	 * the end of the structure is external and internal ABI. */
	// NOTE: Mhm, the dtv here and the canary is not at the same location for musl
	// and glibc/uclibc... So the position probably does not matter.
#ifdef TLS_ABOVE_TP
	uintptr_t canary;
	uintptr_t *dtv; // accessed from tlsdesc.s
#endif
